...
| `declaration-reporting` | — | 404 | `/api/declarations/v1/declarations` | 16 combos tried; services: devices pro declaration-reporting declarations |
| `jamf-pro-classic` | — | 404 | `/api/jssresource/JSSResource/categories` | 12 combos tried; services: pro classic jamf-pro-classic jssresource |
