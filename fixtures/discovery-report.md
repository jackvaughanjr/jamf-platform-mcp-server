...
| `jamf-pro-classic` | — | 403 | `/api/pro/tenant/{TENANT}/accounts` | 3 combos tried; services: pro |
| `jamf-pro-classic-versioned` | `pro` | 200 | `/api/pro/v1/tenant/{TENANT}/buildings` | style `tenant`, envelope: `totalCount` |
